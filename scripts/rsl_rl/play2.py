...
# local imports
import cli_args
#from source.unitree_rl_lab.unitree_rl_lab.devices.keyboard.se2_keyboard import Se2Keyboard, Se2KeyboardCfg  # isort: skip
...
def main():
    ...
    while simulation_app.is_running():
        ...
        device_action = teleop_device.advance()
        #print(device_action)
